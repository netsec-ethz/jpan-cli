...
class PingTest {
  ...
  void main_noArg() {
    ExitCodeException e;
    e = assertThrows(ExitCodeException.class, () -> Cli.run("ping"));
  ...
  void main_badArg() {
    ExitCodeException e;
    e = assertThrows(ExitCodeException.class, () -> Cli.run("ping", "1-123---127.0.0.1"));
    assertEquals(2, e.exitCode());
  ...
  void logLevel_error() {
    ...
    e =
        assertThrows(
            ...
            () -> Cli.run("ping", "1-123,127.0.0.1", "--log.level", "boring"));
    assertEquals(2, e.exitCode());
